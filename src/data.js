...
export const TESTIMONIALS = [
  {
    ...
    quote: "Grâce à l'Institut As-Safaa, j'ai appris à lire couramment en seulement 6 mois. La pédagogie est bienveillante et les enseignants sont extrêmement patients.",
    stars: 5,
    initials: 'FB',
  },
  {
