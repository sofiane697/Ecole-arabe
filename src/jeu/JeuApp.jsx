...
const LECON_SCENES = {
  ...
  qamariya: {
    img: leconQamariya,
    hotspots: [
      { text: 'اَلْقَمَرُ', x: 73, y: 16 },
      { text: 'وَالْقَمَرِ', x: 70, y: 28 },
      { text: 'اَلْمَسْجِدَ', x: 48, y: 63 },
      { text: 'اَلْأَرْضَ', x: 69, y: 63 },
      { text: 'اَلْقُرْآنَ', x: 89, y: 63 },
      { text: 'وَالْجِبَالِ', x: 50, y: 75 },
      { text: 'وَالْمَرْجَانُ', x: 71, y: 75 },
      { text: 'هُوَ الْأَوَّلُ', x: 90, y: 75 },
    ],
  },
};
