...
const S = {
  ...
  title: { fontSize:28, fontWeight:900, color:'var(--a-gold)', letterSpacing:'-1px' },
  ...
  identifiant: { fontSize:13, fontFamily:'monospace', color:'var(--a-gold)', fontWeight:700, letterSpacing:.5 },
