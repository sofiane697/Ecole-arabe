...
const S = {
  ...
  // Student list
  list: { background:'var(--a-bg-card)', borderRadius:12, border:'1px solid var(--a-border)', overflow:'hidden' },
  listHeader: {
    padding:'11px 16px', borderBottom:'1px solid var(--a-border)',
    fontSize:11, fontWeight:700, color:'var(--a-fg-mid)', letterSpacing:1, textTransform:'uppercase',
  },
  listItem: (active) => ({
  ...
  listSub:  { fontSize:11, color:'var(--a-fg-mid)', marginTop:1 },
  // Right panel
  panel: {
  ...
  textarea: {
    width:'100%', minHeight:110, background:'var(--a-bg)', border:'1px solid var(--a-border)',
    color:'var(--a-fg)', borderRadius:10, padding:'12px', fontSize:14, lineHeight:1.65,
  ...
  histSep: {
    ...
    fontSize:11, fontWeight:700, color:'var(--a-fg-mid)', textTransform:'uppercase', letterSpacing:1,
  },
  histSepLine: { flex:1, height:1, background:'var(--a-border)' },
  histItem: {
    padding:'14px', borderRadius:10, border:'1px solid var(--a-border)',
  ...
  delBtn: {
    position:'absolute', top:10, right:10, padding:5, borderRadius:6,
    background:'transparent', border:'none', color:'var(--a-fg-light)',
    cursor:'pointer', display:'flex', alignItems:'center',
  },
  // Placeholder panel
  emptyPanel: {
    background:'var(--a-bg-card)', borderRadius:12, border:'1px solid var(--a-border)',
