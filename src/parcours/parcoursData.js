...
const TARIFS_EDI = [
  ...
  },
  {
    ...
    prix: 99,
    rythme: '15 séances · 40 min / semaine',
    features: ['Histoire du pèlerinage', 'Conditions du pèlerinage', 'Les étapes des rites'],
  },
  {
    id: 'edi-lavage',
...
const TARIFS_EDI_ENFANT = [
  {
    ...
    features: [
      ...
      'Découverte des ablutions et de la prière',
    ],
  },
  {
    id: 'enf-edi-mod2',
...
const TARIFS_COMBO_ENFANT_VISIO = [
  {
    ...
    titre: 'Module 1',
    prix: 290,
    rythme: '45 séances au total · 2 × 40 min / semaine',
    featureGroups: [
      {
        titre: 'Partie Coran',
        items: [
  ...
  children: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          ar: 'الصغار',
          ico: 'ص',
          desc: 'Enseignement destiné aux enfants.',
          children: [
            {
              id: 'enfant-autonomie',
              label: 'Autonomie',
