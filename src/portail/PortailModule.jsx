...
const S = {
  backBtn: { display:'inline-flex', alignItems:'center', gap:6, fontSize:13, fontWeight:500, color:'var(--p-fg-mid)', cursor:'pointer', marginBottom:20, background:'none', border:'none', padding:0 },
  moduleHeader: { marginBottom:24 },
  moduleTitle: { fontFamily:'var(--p-font-display)', fontSize:22, fontWeight:700, color:'var(--p-fg)', margin:'0 0 6px' },
  moduleDesc: { fontSize:14, color:'var(--p-fg-mid)', marginTop:4 },
  ...
  cardImgContainer: (bg) => ({ width:'100%', height:160, background: bg || 'linear-gradient(135deg, #1c1c1e 0%, #2c2c2e 100%)', display:'flex', alignItems:'center', justifyContent:'center' }),
  cardImgPlaceholder: { fontSize:44, opacity:0.4 },
  cardBody: { padding:20 },
  cardTitle: { fontSize:17, fontWeight:700, color:'#1a1a1a', margin:'0 0 6px' },
  cardDesc: { fontSize:13, color:'rgba(0,0,0,0.58)', marginBottom:14, marginTop:0, lineHeight:1.5 },
  ...
  progressText: { display:'flex', justifyContent:'space-between', marginTop:6, fontSize:11, color:'rgba(0,0,0,0.52)' },
  btn: (palette) => ({ display:'flex', alignItems:'center', justifyContent:'center', gap:6, padding:'11px 20px', borderRadius:980, border:'none', background: palette ? palette.btnGrad : 'var(--p-gold)', boxShadow: palette ? `0 4px 12px ${palette.btnShadow}` : 'none', color:'#fff', fontSize:13, fontWeight:600, cursor:'pointer', marginTop:16, width:'100%', boxSizing:'border-box', transition:'opacity .2s, transform .15s' }),
  btnCompleted: (palette) => ({ display:'flex', alignItems:'center', justifyContent:'center', gap:6, padding:'11px 20px', borderRadius:980, border:'none', background: palette ? palette.btnGrad : 'var(--p-green)', boxShadow: palette ? `0 4px 12px ${palette.btnShadow}` : 'none', color:'#fff', fontSize:13, fontWeight:600, cursor:'pointer', marginTop:16, width:'100%', boxSizing:'border-box', opacity:0.85 }),
...
function ModuleEntryView({ moduleId }) {
  ...
  return (
    <div>
      ...
      {module_ && (
        <div style={S.moduleHeader}>
          <h1 style={{ fontFamily:'var(--p-font-display)', fontSize:24, fontWeight:800, color:'var(--p-fg)', margin:'0 0 6px', lineHeight:1.25 }}>
            {module_.titre}
          </h1>
...
function LeconsEntryView({ thId, moduleId, thematiqueTitle, onBack }) {
  ...
  return (
    <div>
      ...
      <div style={S.moduleHeader}>
        <h1 style={{ fontSize:25, fontWeight:800, color:'var(--p-fg)', marginBottom:8, marginTop:0, letterSpacing:'-0.3px', lineHeight:1.2 }}>
          {thematiqueTitle}
        </h1>
      </div>
...
const NS = {
  ...
  progressLeft: { display:'flex', flexDirection:'column', gap:3, flexShrink:0 },
  ...
  progressPct: { fontSize:13, fontWeight:700, color:'var(--p-green)', flexShrink:0 },
  // Zone 2 — Chips navigation
  chipsRow: { display:'flex', gap:8, overflowX:'auto', paddingBottom:4, marginBottom:20 },
  ...
  chipLabel: { maxWidth:110, overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap' },
  ...
  lockedPrevBtn: { display:'inline-flex', alignItems:'center', gap:6, padding:'10px 22px', borderRadius:9999, border:'1px solid var(--p-border)', background:'transparent', color:'var(--p-fg-mid)', fontSize:13, fontWeight:600, cursor:'pointer' },
  ...
  qcmBackLink: { display:'block', textAlign:'center', marginTop:16, fontSize:13, color:'var(--p-fg-light)', cursor:'pointer', background:'transparent', border:'none', width:'100%' },
  // Résultat
    ...
    <div>
      ...
      {isLocked ? (
        ...
        <div style={NS.qcmCard}>
          ...
          {submitError && (
            <div style={{ marginTop:12, padding:'10px 14px', borderRadius:8, background:'rgba(255,69,58,0.08)', border:'1px solid rgba(255,69,58,0.25)', color:'var(--p-red)', fontSize:13 }}>
              {submitError}
            </div>
          )}
